...
DEMO_PRESETS = {
    ...
    "jump": {
        "name": "jump",
        "duration_s": 3.0,
        "commands": [0.0, 0.0, 0.0, 2.35, 0.0, 0.5, 0.20, 0.03, 0.00, 0.0],
    },
    "walk": {
        "name": "walk",
        "duration_s": 6.0,
    ...
    "run": {
        "name": "run",
        "duration_s": 6.0,
        # Keep the run demo aligned with evaluate.py and configs/ablation/motion_run.json.
        "commands": [1.60, 0.0, 0.0, 3.00, 0.5, 0.5, 0.20, 0.00, 0.03, 0.0],
    },
    "fast_walk": {
        "name": "fast_walk",
        "duration_s": 6.0,
...
DEMO_SEQUENCE_NAMES = ["walk", "jump", "run"]
